...
let tasks = examples.map((eg, i) => {
    return { type: "shell", label: emoji[Math.floor(Math.random()*emoji.length)]+" "+eg.title, detail: eg.summary, command: "echo 'hiya'", problemMatcher: [] }
});
